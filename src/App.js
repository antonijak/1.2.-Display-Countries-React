...
class App extends Component {
  ...
  findMatch = () => {
    let result = countries.filter((country) => {
      ...
      let match = upperCaseCountry.includes(userUpper);
      if (match){ 
    ...
    return (
      <div className="App">
        <header>
          ...
          <button type="submit" id="starting-word" className="buttons">Starting Word</button>
          <button type="submit" id="any-word" className="buttons">Any word</button>
          <input onChange={this.updateInputValue} type="text" placeholder="Search by..." id="search"/>
        </header>
        <main>
